...
## Corpus Check
- 325 files · ~186,704 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2628 nodes · 4613 edges · 198 communities (151 shown, 47 thin omitted)
- Extraction: 90% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 433 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `614d968e`
...
10. `MockConfigRepositoryTest` - 31 edges
...
Cohesion: 0.06
Nodes (66): AnalyticsLogger, AnalyticsLogItem(), AnalyticsLogItemPreview(), Modifier, CategoryChip(), CategoryChipPreview(), Modifier, AnalyticsLog (+58 more)
...
Cohesion: 0.06
Nodes (51): Animatable, AnimationVector1D, BorderStroke, Constraints, FeatureTriStateSwitchTest, FeatureItem(), FeatureItemPreview(), Feature (+43 more)
...
### Community 8 - "EndpointHeaderCard"
Cohesion: 0.36
Nodes (6): EndpointHeaderCard(), EndpointHeaderCardPreview(), Modifier, OperationUiModel, OperationUiModel, OperationUiModelPreviewParameterProvider
...
Cohesion: 0.05
Nodes (34): createMockHttpClientCall(), HttpClient, HttpStatusCode, MockHttpClientCall, NetworkMockPluginConfig, Exception, HttpClientCall, HttpClientConfig (+26 more)
...
Cohesion: 0.15
Nodes (7): DataStore, Preferences, NetworkMockInitializer, Flow, Preferences, MockStateRepository, NetworkMockConfig
...
Cohesion: 0.13
Nodes (28): EndpointMockState (api 0.1.1), EndpointMockState.Mock (api 0.1.1), EndpointMockState.Network (api 0.1.1), MockStateRepository (api 0.1.1), NetworkMockInitializer (api 0.1.1), NetworkMockState (api 0.1.1), EndpointMockState (api 0.1.2), EndpointMockState.Mock (api 0.1.2) (+20 more)

### Community 27 - "MockConfigRepository (api 0.1.3)"
Cohesion: 0.16
Nodes (24): EndpointKey (api 0.1.3), MockConfigRepository (api 0.1.3), MockConfiguration (api 0.1.3), MockMatch (api 0.1.3), NetworkMockInitializer (api 0.1.3), NetworkMockResourceLoader (api 0.1.3), EndpointDescriptor (api 0.1.4), EndpointKey (api 0.1.4) (+16 more)
...
Cohesion: 0.18
Nodes (6): OperationDescriptor, ApiSpecUiModel, MockScreenTestData, ApiSpecUiModel, StateFlow, ViewModel

### Community 56 - "MockConfigRepository (api 0.1.2)"
Cohesion: 0.25
Nodes (14): EndpointDescriptor (api 0.1.1), EndpointKey (api 0.1.1), MockConfigRepository (api 0.1.1), MockConfiguration (api 0.1.1), MockMatch (api 0.1.1), MockResponse (api 0.1.1), EndpointDescriptor (api 0.1.2), EndpointKey (api 0.1.2) (+6 more)
...
Cohesion: 0.29
Nodes (13): Modifier, MockItem(), MockItemContent(), MockItemPreview(), MockItemPreviewModePreview(), MockItemSelectedPreview(), NetworkItem(), NetworkItemPreview() (+5 more)
...
Cohesion: 0.14
Nodes (9): MockResponse, Result, MockConfigRepository, PreviewParameterProvider, MockResponsePreviewParameterProvider, exampleStatusCode(), fake(), ApiSpecUiModel (+1 more)
...
### Community 76 - "TimeCapsule"
Cohesion: 0.15
Nodes (12): ModuleDestinationActionPopup, DestinationMetadataExtensionsTest, NavKey, TestNavKey, Dp, KClass, Module, NavKey (+4 more)
...
### Community 80 - "NetworkMockEndpointUiState"
Cohesion: 0.40
Nodes (6): Content, EndpointLoadingState, Error, Loaded, Loading, NetworkMockEndpointUiState
...
### Community 82 - "module-expert Agent"
Cohesion: 0.24
...
Cohesion: 0.14
Nodes (16): HomeScreenTest, Home, HomeScreen(), HomeScreenPreview(), Modifier, Module, Modifier, Module (+8 more)

### Community 88 - "NetworkMockScreen.kt"
Cohesion: 0.07
Nodes (28): GlobalMockToggleTest, NetworkMockScreenTest, EmptyState(), Modifier, EndpointCard(), EndpointCardPreview(), EndpointCardWithFileNamePreview(), Modifier (+20 more)
...
### Community 93 - "mocks_json_to_openapi.py"
Cohesion: 0.15
Nodes (29): Path, attach_env_examples(), build_responses(), check_unknown_keys(), convert_file(), convert_group(), derive_override_operation_id(), discover_files() (+21 more)
...
Cohesion: 0.24
Nodes (8): add-konsist-rule Skill, konsist/build.gradle.kts, ComposeTest, FunSpec, FunSpec, PackageNamingTest, FunSpec, ViewModelTest
...
Cohesion: 0.15
Nodes (19): DestinationMetadata, DestinationMetadataBuilder, ImageVector, PersistentList, asDestination(), KClass, NavKey, withActions() (+11 more)
...
### Community 119 - "NetworkMockEndpointScreen.kt"
Cohesion: 0.29
Nodes (10): ErrorState(), Modifier, Modifier, LoadingState(), Dp, Modifier, OperationUiModel, NetworkMockEndpointScreen() (+2 more)
...
## Knowledge Gaps
- **529 isolated node(s):** `Detail`, `Main`, `Poko`, `Mock`, `Network` (+524 more)
